...
const model = new MockEmbeddingModelV3({
  // AI SDK's test mock types `doEmbed` against its internal `EmbeddingModelV3['doEmbed']` method
...
} as unknown as ConstructorParameters<typeof MockEmbeddingModelV3>[0]);
